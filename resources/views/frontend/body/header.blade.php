        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="index.html"><img src="{{asset('frontend/ssets/imgs/theme/logo.svg')}}" alt="logo" /></a>
                </div>
                ...
                <div class="hotline d-none d-lg-flex">
                    <img src="{{asset('frontend/ssets/imgs/theme/icons/icon-headphone.svg')}}a" alt="hotline" />
