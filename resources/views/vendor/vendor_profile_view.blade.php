        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Vendor User Profilep</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{! empty($vendorData->photo)?url('uploads/vendor_images/'.$vendorData->photo):url('uploads/no_image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{! empty($vendorData->photo)?url('uploads/admin_images/'.$vendorData->photo):url('uploads/no_image.jpg')}}"
